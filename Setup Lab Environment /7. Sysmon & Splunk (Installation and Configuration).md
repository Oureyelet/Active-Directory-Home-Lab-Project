...
<b>Now we have Splunk up and running we want to install Splunk Universal Forwarder (A Splunk Universal Forwarder is a dedicated, streamlined version of Splunk Enterprise that contains only the essential components needed to forward data) on both Target machine and our server </b>
