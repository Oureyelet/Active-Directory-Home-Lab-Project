...
<b>I'm going to create new a new file under the local directory becouse you do not want to edit the inputs.conf file under the default directory that is there just in case you mess anything up you can replace that with the default config </b>
...
<b>I've copied the content in my 'inputs.conf' file that I will leave below</b> 20:19

<b>[WinEventLog://Application]
